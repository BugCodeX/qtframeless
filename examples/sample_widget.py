"""Minimal example demonstrating a frameless QWidget with custom TitleBar."""
...
class Window(FramelessWidget):
    """Frameless QWidget window showcase."""
    ...
    def _setupContent(self) -> None:
        """Configure window properties, title bar, and central content."""
