"""Showcase window with native Windows 11 Mica backdrop material."""
...
class MicaWindow(FramelessMicaMainWindow):
    """Frameless window with Windows 11 native Mica backdrop."""
    ...
    def _setupContent(self) -> None:
        """Configure Mica backdrop, title bar, and content widgets."""
        self.setWindowTitle("Windows 11 Mica Material")
        self.resize(760, 480)
